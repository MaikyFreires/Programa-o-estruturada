...
Nº chassi: _________________________ 
Ano: __________ 
Placa: ____________
Em que:
...
Sabendo que não temos uma definição do número máximo de veículos da cidade e que é preciso armazenar 
todos os valoresem uma lista encadeada simples,construa:
a.Uma função que liste todos os proprietários cujos carros são do ano de 2010 ou posterior e 
que sejam movidos a diesel.
b.Uma função que liste todas as placas que comecem com a letra J e terminem com 0, 2, 4 ou 7 e seus respectivos 
proprietários.
c.Uma função que  liste  o modelo e  a cor dos veículos cujas placas possuem como segunda letra uma vogal e
cuja soma dos valores numéricos fornece um número par.
...
struct veiculo {
  char proprietario[30], combustivel, modelo[30], cor[30], placa[7];
  int chassi, ano;
};
...
void incluir(struct no **lista, struct no *novo){
  ...
  fflush(stdin);
  fgets(novo->dados.proprietario,30,stdin);
  printf("Digite o modelo:\n");
  fflush(stdin);
  fgets(novo->dados.modelo,30,stdin);
  printf("Digite a cor:\n");
  fflush(stdin);
  fgets(novo->dados.cor,30,stdin);
  printf("Combustivel (A)lcool, (D)iesel ou (G)asolina \n");
  scanf("%c", &novo->dados.combustivel);
  printf("Digite a placa:\n");
  fflush(stdin);
  fgets(novo->dados.placa,7,stdin);
  printf("Digite o ano: \n");
  scanf("%d", &novo->dados.ano);
  printf("Digite o chassi: \n");
  scanf("%d", &novo->dados.chassi);
  ...
  while (aux != NULL) {
    if (aux->dados.placa[1]=='A'|| aux->dados.placa[1]=='E' || aux->dados.placa[1]=='I' || aux->dados.placa[1]=='O'|| aux->dados.placa[1]=='U'){
      ...
      switch (aux->dados.placa[3]) {
        case '0': numeroPlaca=0;
         break;
        case '1': numeroPlaca=1; 
        break;
        case '2': numeroPlaca=2; 
        break;
        case '3': numeroPlaca=3; 
        break;
        case '4': numeroPlaca=4;
        break;
        case '5': numeroPlaca=5;
        break;
        case '6': numeroPlaca=6; 
        break;
        case '7': numeroPlaca=7; 
        break;
        case '8': numeroPlaca=8; 
        break;
        case '9': numeroPlaca=9;
         break;
      }
      switch (aux->dados.placa[4]) {
        case '0': numeroPlaca2=0;
        break;
        case '1': numeroPlaca2=1; 
        break;
        case '2': numeroPlaca2=2; 
        break;
        case '3': numeroPlaca2=3; 
        break;
        case '4': numeroPlaca2=4; 
        break;
        case '5': numeroPlaca2=5; 
        break;
        case '6': numeroPlaca2=6;
        break;
        case '7': numeroPlaca2=7; 
        break;
        case '8': numeroPlaca2=8; 
        break;
        case '9': numeroPlaca2=9; 
        break;
      }
      switch (aux->dados.placa[5]) {
        case '0': numeroPlaca3=0; 
        break;
        case '1': numeroPlaca3=1; 
        break;
        case '2': numeroPlaca3=2; 
        break;
        case '3': numeroPlaca3=3; 
        break;
        case '4': numeroPlaca3=4; 
        break;
        case '5': numeroPlaca3=5; 
        break;
        case '6': numeroPlaca3=6; 
        break;
        case '7': numeroPlaca3=7; 
        break;
        case '8': numeroPlaca3=8; 
        break;
        case '9': numeroPlaca3=9; 
        break;
      }
      switch (aux->dados.placa[6]) {
        case '0': numeroPlaca4=0; 
        break;
        case '1': numeroPlaca4=1; 
        break;
        case '2': numeroPlaca4=2; 
        break;
        case '3': numeroPlaca4=3; 
        break;
        case '4': numeroPlaca4=4; 
        break;
        case '5': numeroPlaca4=5; 
        break;
        case '6': numeroPlaca4=6; 
        break;
        case '7': numeroPlaca4=7; 
        break;
        case '8': numeroPlaca4=8; 
        break;
        case '9': numeroPlaca4=9; 
        break;
      }
...
struct no *editar2(struct no *edicao){
  ...
  fflush(stdin);
  fgets(edicao->dados.proprietario,30,stdin);
  return 0;
}
